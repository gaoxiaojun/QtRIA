...
Component.prototype.beginInstallation = function()
{
    ...
    if (installer.value("os") == "win") {
        component.qtCreatorBinaryPath = component.qtCreatorBinaryPath + "\\bin\\qforex.exe";
        component.qtCreatorBinaryPath = component.qtCreatorBinaryPath.replace(/\//g, "\\");
    }
    else if (installer.value("os") == "x11")
        component.qtCreatorBinaryPath = component.qtCreatorBinaryPath + "/bin/qforex";
    else if (installer.value("os") == "mac")
        component.qtCreatorBinaryPath = component.qtCreatorBinaryPath + "/QForex.app/Contents/MacOS/QForex";
